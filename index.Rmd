...
```{r}
# Reads in our world map dataset
...
# # Reads in our world map datasets
# 
# freedom_map <- ggplot(data = world_happiness_map, aes(geometry = geom, fill = `freedom to make choices`)) +
#   geom_sf()+
#   theme_void() + # removes axes
#   # more informative plot/legend/caption titles
#   labs(title = "World Freedom to Make Life Choice"
#        , caption = "Data from Our World in Data and World Happiness Report (2019-2022)"
#        , fill = "Freedom to Make Life Choices", "Score") +
#   # coloring to make chloropleth more readable
#   scale_fill_viridis(option = "mako", direction = -1) 
# 
# # Creates animation object of the freedom map
# freedom_map_animation <- freedom_map + 
#   transition_states(
...
# 
# # Runs the animation
# animate(freedom_map_animation, height = 400, width = 800) 
```
...
# Country Freedom According to Policy (Text Analysis)
