...
```{r, fig.cap='COVID-19 Virus. Taken from the Center for Disease Control and Prevention.', out.width="100%", fig.align="center"}
...
ggplotly(cases_vs_freedom_plot, tooltip = "Country") 
```
