...
## Freedom According to the World Happiness Report vs COVID Cases
...
scatterplot_data <- readRDS("data/scatterplot_data_without_2019.rds") 
 ...
 ggplot(data = scatterplot_data 
           , aes_string( # Maps aesthetics from strings
             ...
             y = "tot_year_cases",
             color = "year")) + # Sets deaths or cases as the user chosen y variable
      ...
      labs(x = "Freedom to Make Life Choices Score" # Sets the x axis label
           , y = "COVID Cases (per million)" # Changes y label based on user choice
...
ggplot(data = world_happiness_map, aes(geometry = geom, fill = `freedom to make choices`)) +
  ...
  labs(title = "World Freedom to Make Life Choices in 2020"
       , caption = "Data from Our World in Data and World Happiness Report (2020-2023)"
...
Across years, there appeared to be no great differences between countries in 
...
We chose to study the countries Lebanon and Mongolia (Asia), Venezuela and Panama (South America), Senegal (Africa), as well as the United Kingdom and Switzerland (Europe). 
